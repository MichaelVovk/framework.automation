...
/**
 * Listener class to capture screenshots after test methods execution
 * @author Taras.Lytvyn
 *
 */
//framework.utils.listeners.ScreenshotFailureTestListener
public class ScreenshotFailureTestListener extends TestListenerAdapter {
	...
	/**
	 * creates mobile screenshot after test fail
	 * @param result	result
	 * @return	image byte array
	 */
	 ...
	 * @param screenshotType	screenshot type
